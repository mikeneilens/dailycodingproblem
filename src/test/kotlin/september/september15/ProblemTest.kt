...
class ProblemTest: StringSpec( {
    "Number of routes for a 1 by 1 grid is 1 " {
        routes(Matrix(1,1)) shouldBe listOf(listOf(Position(1,1)))
    }
    "Number of routes for 2 by 2 grid is 2" {
        routes(Matrix(2,2)) shouldBe listOf(
    ...
    "Number of routes for 3 by 2 grid is 3" {
        routes(Matrix(3,2)) shouldBe listOf(
    ...
    "Number of routes for 5 by 5 grid is 70" {
        routes(Matrix(5,5)).size shouldBe 70
    }
})