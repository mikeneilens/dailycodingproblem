...
import august.august07.Position
import august.august07.problem
import august.august07.toChart
...
class ProblemTest: StringSpec( {
    ...
    "parse [[true, false, true], [false, true, false]] should give set of [Position(1,0), Position(0,1),Position(2,1)]" {
        listOf(listOf(true, false, true), listOf(false, true, false)).toChart() shouldBe setOf(
            Position(
            0,
            1
