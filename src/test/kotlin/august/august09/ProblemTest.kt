package august.august09

import august.august09.RegexItem
import august.august09.parse
import august.august09.problem
...
class ProblemTest: StringSpec( {
    ...
    "when string contains ac and regex is ab* then return false" {
        val regex = "ab*".parse()
        problem("ac", regex) shouldBe false
    }
